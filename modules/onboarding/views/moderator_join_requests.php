                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?php if ($item['status'] === 'pending'): ?>
                                    <form method="POST" action="/moderator/join-requests/<?= (int) $item['id'] ?>/approve" style="display:inline;">
                                        <?= csrf_field() ?>
                                        <button type="submit" class="btn btn-sm btn-primary">Approve</button>
                                    </form>
                                    <form method="POST" action="/moderator/join-requests/<?= (int) $item['id'] ?>/reject" style="display:inline;">
                                        <?= csrf_field() ?>
